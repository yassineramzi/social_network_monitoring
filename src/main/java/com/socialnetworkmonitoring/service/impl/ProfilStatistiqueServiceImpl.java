    ...
    public List<ProfilStatistiqueDTO> findProfilStatistiquesByIdProfil(Long idProfil) {
        ...
        for(Map.Entry<Date,List<ProfilStatistiqueDTO>> entry : statistiqueDTOMap.entrySet()) {
            ...
            if(!CollectionUtils.isEmpty(profilStatistiqueDTOListTemp)){
                ...
                profilStatistiqueDTO.setNombreFollowersYoutube(profilStatistiqueDTOYoutube!=null ? profilStatistiqueDTOTwitter.getNombreFollowersYoutube() : null);
                profilStatistiqueDTO.setNombreVuesYoutube(profilStatistiqueDTOYoutube!=null ? profilStatistiqueDTOTwitter.getNombreVuesYoutube() : null);
                // Instagram
                ...
                profilStatistiqueDTO.setNombreFollowersInstagram(profilStatistiqueDTOInstagram!=null ? profilStatistiqueDTOTwitter.getNombreFollowersInstagram() : null);
            }
